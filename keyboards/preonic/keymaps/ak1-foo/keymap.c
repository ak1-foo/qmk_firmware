...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_LOWER] = LAYOUT_preonic_grid( \
      XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, \
      XXXXXXX,        KC_PERCENT, KC_MINUS,  KC_NUBS,   KC_CIRCUMFLEX, KC_GRAVE,     KC_DEL,    LGUI(KC_LEFT), LGUI(KC_DOWN), LGUI(KC_UP),  LGUI(KC_RIGHT),  XXXXXXX, \
      XXXXXXX,        KC_PLUS, KC_ASTR,     KC_SLASH,   KC_EQUAL,      KC_TILD,     KC_BSPC,     KC_LEFT,  KC_DOWN,   KC_UP,   KC_RIGHT,  XXXXXXX, \
      XXXXXXX,        KC_HASH, KC_DOLLAR, KC_QUESTION,  KC_AT,         KC_EXLM,     LCTL(KC_BSPC),      KC_HOME,  KC_PGDOWN, KC_PGUP, KC_END,    XXXXXXX, \
      XXXXXXX,     XXXXXXX,   XXXXXXX,     XXXXXXX,     XXXXXXX,      XXXXXXX,           ADJUST,   KC_F17,   KC_LGUI,   XXXXXXX,     XXXXXXX,  XXXXXXX \
      ),

  [_RAISE] = LAYOUT_preonic_grid( \
      XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, \
      XXXXXXX,     LCTL(KC_TAB),    KC_7,  KC_8,   KC_9,             KC_COMMA,            KC_PIPE,        KC_LT,     KC_GT,     KC_LCBR,  KC_RCBR, XXXXXXX, \
