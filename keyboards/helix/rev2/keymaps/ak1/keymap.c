...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   */
  [_QWERTY] = LAYOUT(
      KC_5,  KC_4,    KC_3,    KC_2,    KC_1,    XXXXXXX,                      KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_DEL,
      KC_T,  KC_R,    KC_E,    KC_W,    KC_Q,    KC_ESC,                      KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_BSPC,
      KC_G, KC_F,    KC_D,    KC_S,    KC_A,    KC_TAB,                      KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,
      KC_B, KC_V,    KC_C,    KC_X,    KC_Z,    KC_LSFT,    XXXXXXX, KC_RBRC, KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_ENT ,
      KC_SPACE,  KC_LALT,  KC_M, KC_ENT, XXXXXXX,    KC_LCTL,  LALT(KC_F10),  KC_SPACE, RAISE,   KANA,    KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
      ),
